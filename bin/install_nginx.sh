...
NGINX_VERSION="1.25.3"  # https://nginx.org/en/download.html
OPENSSL_VERSION="3.1.4" # https://github.com/openssl/openssl/tags
ZLIB_VERSION="1.3"	# https://github.com/madler/zlib/tags
